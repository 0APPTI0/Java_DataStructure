...
public class BTreeTest {
    ...
    private final List<Integer> keys = new ArrayList<Integer>(12);
    private final List<List<Integer[]>> insertResults = new ArrayList<List<Integer[]>>(12);
    private final List<List<Integer[]>> deleteResults = new ArrayList<List<Integer[]>>(12);
    ...
    private <K extends Comparable<K>> boolean checkBTree(BTree<K> tree, List<K[]> result)
        ...
        Queue<AbstractBTreeNode<K>> nodes = new LinkedList<AbstractBTreeNode<K>>();
